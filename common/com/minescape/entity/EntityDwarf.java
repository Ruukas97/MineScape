...
public class EntityDwarf extends EntityMob//extend this to make mob hostile
{
public EntityDwarf(World par1World)
{
	super(par1World);//super call
	this.texture = "/mods/minescape/textures/mobs/dwarf.png";//specifies texture
