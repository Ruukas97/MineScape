...
import com.minescape.lib.ItemIDs;
import com.minescape.lib.ItemStrings;
import com.minescape.lib.MineScapeMaterials;
...
public class Items {	
	...
	//Logs
	public static Item logLogs;
	public static Item logOak;
	public static Item logWillow;
	public static Item logMaple;
	public static Item logYew;
	...
	public static void init()
	{
		...
		//WOODCUTTING AND FIREMAKING------------------------------------------------------------------------------------------------------------
		logLogs = new MineScapeItem(ItemIDs.LOG_LOGS).setUnlocalizedName(ItemStrings.LOG_LOGS_NAME);
		logOak = new MineScapeItem(ItemIDs.LOG_OAK).setUnlocalizedName(ItemStrings.LOG_OAK_NAME);
		logWillow = new MineScapeItem(ItemIDs.LOG_WILLOW).setUnlocalizedName(ItemStrings.LOG_WILLOW_NAME);
		logMaple = new MineScapeItem(ItemIDs.LOG_MAPLE).setUnlocalizedName(ItemStrings.LOG_MAPLE_NAME);
		logYew = new MineScapeItem(ItemIDs.LOG_YEW).setUnlocalizedName(ItemStrings.LOG_YEW_NAME);
		
		//Other
		tinderbox = new MineScapeItem(ItemIDs.TINDERBOX).setUnlocalizedName(ItemStrings.TINDERBOX_NAME);
		...
		//Logs
		LanguageRegistry.addName(logLogs, ItemStrings.LOG_LOGS_TRANSNAME);
		LanguageRegistry.addName(logOak, ItemStrings.LOG_OAK_TRANSNAME);
		LanguageRegistry.addName(logWillow, ItemStrings.LOG_WILLOW_TRANSNAME);
		LanguageRegistry.addName(logMaple, ItemStrings.LOG_MAPLE_TRANSNAME);
		LanguageRegistry.addName(logYew, ItemStrings.LOG_YEW_TRANSNAME);
		//Other
		LanguageRegistry.addName(tinderbox, ItemStrings.TINDERBOX_TRANSNAME);
