...
public class ItemIDs
{
	...
	public static int WOODCUTING_DEFAULT = ID_DEFAULT;
	
	//Logs
	public static int LOG_LOGS_DEFAULT = WOODCUTING_DEFAULT;
	public static int LOG_OAK_DEFAULT = WOODCUTING_DEFAULT + 1;
	public static int LOG_WILLOW_DEFAULT = WOODCUTING_DEFAULT + 2;
	public static int LOG_MAPLE_DEFAULT = WOODCUTING_DEFAULT + 3;
	public static int LOG_YEW_DEFAULT = WOODCUTING_DEFAULT + 4;
	
	//Other
	public static int TINDERBOX_DEFAULT = WOODCUTING_DEFAULT + 5;

	//MINING AND SMELTING---------------------------------------------------------------------------------------------------------------
	
	//Ores
	public static int ORES_DEFAULT = TINDERBOX_DEFAULT + 1;
	...
	//Logs
	public static int LOG_LOGS;
	public static int LOG_OAK;
	public static int LOG_WILLOW;
	public static int LOG_MAPLE;
	public static int LOG_YEW;
	
	//Other
	public static int TINDERBOX;
