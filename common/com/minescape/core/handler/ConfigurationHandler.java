...
import com.minescape.lib.BlockIDs;
import com.minescape.lib.BlockStrings;
...
public class ConfigurationHandler {
	...
	public static void loadConfig(File file)
	{
		...
		try {
			...
			//Logs
			ItemIDs.LOG_LOGS = config.getItem(ItemStrings.LOG_LOGS_TRANSNAME, ItemIDs.LOG_LOGS_DEFAULT).getInt();
			ItemIDs.LOG_OAK = config.getItem(ItemStrings.LOG_OAK_TRANSNAME, ItemIDs.LOG_OAK_DEFAULT).getInt();
			ItemIDs.LOG_WILLOW = config.getItem(ItemStrings.LOG_WILLOW_TRANSNAME, ItemIDs.LOG_WILLOW_DEFAULT).getInt();
			ItemIDs.LOG_MAPLE = config.getItem(ItemStrings.LOG_MAPLE_TRANSNAME, ItemIDs.LOG_MAPLE_DEFAULT).getInt();
			ItemIDs.LOG_YEW = config.getItem(ItemStrings.LOG_YEW_TRANSNAME, ItemIDs.LOG_YEW_DEFAULT).getInt();
			
			//Other
			ItemIDs.TINDERBOX = config.getItem(ItemStrings.TINDERBOX_TRANSNAME, ItemIDs.TINDERBOX_DEFAULT).getInt();
